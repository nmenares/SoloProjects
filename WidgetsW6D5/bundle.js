...
var Autocomplete = function (_React$Component) {
  ...
  function Autocomplete(props) {
    ...
    _this.state = { inputVal: "", names: props.names.slice(0) };
  ...
  _createClass(Autocomplete, [{
    key: "updateSearch",
    value: function updateSearch(value) {
      this.setState({
        inputVal: value,
        names: this.props.names.filter(function (el) {
    ...
    key: "handleClick",
    value: function handleClick(name, event) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "box" },
        _react2.default.createElement("input", { type: "text", onChange: this.handleChange, value: this.state.inputVal, placeholder: "Search..." }),
        _react2.default.createElement(
          "ul",
          null,
          this.state.names.length === 0 ? _react2.default.createElement(
            "li",
            null,
            "No Results"
          ) : this.state.names.map(function (el, idx) {
            return _react2.default.createElement(
              "li",
              { onClick: _this2.handleClick.bind(_this2, el), key: idx },
              el
            );
          })
        )
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    key: 'click',
    value: function click(index, event) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.tabs.map(function (el, idx) {
            return _react2.default.createElement(
              'li',
              { className: _this2.state.index === idx ? 'active' : '', onClick: _this2.click.bind(_this2, idx), key: idx },
              _react2.default.createElement(
                'h1',
                null,
                el.title
  ...
  _createClass(Weather, [{
    ...
    value: function componentDidMount() {
      ...
      navigator.geolocation.getCurrentPosition(function (location) {
        ...
        var apiKey = '077861841fa9a2ade7a0321993cae8a9';
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_tabs2.default, { tabs: [{ title: 'one', content: 'I am the first' }, { title: 'two', content: 'Second pane here' }, { title: 'three', content: 'Third pane here' }] })
      ),
      _react2.default.createElement(
        'div',
        null,
        ...
        _react2.default.createElement(_autocomplete2.default, { names: ['alan', 'ana', 'anabelle', 'alfonso', 'alicia', 'brenda'] })
      )
    )
  );
};
